...
public class ObjectToJSONConverter {
	...
	if(Objects.isNull(obj)) {
		throw new JsonSerializableException("Can't serialize with object");
	}
	
	Class<?> clazz = obj.getClass();
	if(!clazz.isAnnotationPresent(JsonSerializable.class)) {
		throw new JsonSerializableException("This class" +
	 clazz.getSimpleName() + "is not annotated with " + " JSon Serializable annotation");
	}
}
