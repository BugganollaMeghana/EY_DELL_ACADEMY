...
public class WorkWithDatabase {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String dbURL = "jdbc:mysql://localhost:3306/hplus?user=root&password=root"; //3306 is local host for mysql
           ...
           if(j==0) System.out.println("Drop Completed Succesfully");
            ...
            if(i==0) System.out.println("Table Created Succesfully");
            else System.out.println("table couldn't be created");
            
            String insertSQL = "INSERT INTO Employee VALUES(" + "111,'A','B','Manager')";
            i=stmt.executeUpdate(insertSQL);
            if(i!=0) System.out.println("Insert Query Executed Succesfully");
            else System.out.println("Insert Query couldn't work");
